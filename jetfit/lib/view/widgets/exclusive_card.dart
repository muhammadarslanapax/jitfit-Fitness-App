                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            if (Staticdata.uid != null) {
                                              if (Staticdata.isexclusive!) {
                                                Home01Controller.my
                                                    .singlevideoview(
                                                  videossModel.videoID!,
                                                  Staticdata.uid!,
                                                );
                                                Staticdata.videoModal =
                                                    videossModel;
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    Staticdata.isexclusive!
                                                        ? "play your exclusive content"
                                                        : "\$${videossModel.price} one-time purchase by clicking you confirm an charging",
                                          ...
                                          child: Container(
                                            ...
                                            child: Center(
                                              child: Text(
                                                Staticdata.isexclusive!
                                                    ? "Not ready,yet back"
                                                    : "Not ready,yet.I stay with my Premium content",
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                  color: Colors.grey,
                                                ),
                                  ...
                                  onTap: () {
                                    if (Staticdata.uid != null) {
                                      ...
                                      handlePayment(
                                          Staticdata.uid!,
                                          "exclusive content",
                                          double.parse(videossModel.price!),
                                          context,
                                          videossModel);
                                    } else {
                                      showtoast("Sign in first");
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "\$${videossModel.price} one-time purchase by\n clicking you confirm an charging",
                                            style: TextStyle(
                                              color: Colors.white,
                                              fontSize:
                                                  16, // Adjust the font size as needed
